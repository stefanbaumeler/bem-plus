...
const BemPlusGeneratorConfig = zod__WEBPACK_IMPORTED_MODULE_1__.z.object({
    ...
    output: zod__WEBPACK_IMPORTED_MODULE_1__.z.object({
        ...
        elementClassPrefix: zod__WEBPACK_IMPORTED_MODULE_1__.z.string().default(defaults.output.elementClassPrefix),
        elementClassSuffix: zod__WEBPACK_IMPORTED_MODULE_1__.z.string().default(defaults.output.elementClassSuffix),
        moduleClassPrefix: zod__WEBPACK_IMPORTED_MODULE_1__.z.string().default(defaults.output.moduleClassPrefix),
        moduleClassSuffix: zod__WEBPACK_IMPORTED_MODULE_1__.z.string().default(defaults.output.moduleClassSuffix),
